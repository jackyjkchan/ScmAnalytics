...
from order_policies import DeterministicConDOIPolicyV2, DeterministicConDOIPolicyV2WithoutSchedule
from run_sim import run_booked_surgery_driven_simulation, Booked_Surgery_Config

from scm_analytics import ScmAnalytics
from scm_analytics import config as config1
        ...
        for conD_lvl in levels:
            ...
            for policy in policies:
                ...
                for trial in range(10):
                    ...
                    hospital = run_booked_surgery_driven_simulation(config, simtime=10500, show=True)
                    analytics = ScmAnalytics.ScmAnalytics(config1.LHS())
